...
# @Last Modified time: 2015-05-26 00:34:22
...
class Copier(object):
    ...
    def openfiles(self):
        ...
        self.outputcsv=open(self.destination)
...
class addrow(Copier):
    ...
    def getmanipulators(self):
        self.inputreader=csv.DictReader(self.inputcsv)
        self.outputwriter=csv.DictWriter(self.outputcsv,['AdditionalRow',]+self.inputreader.fieldnames)
